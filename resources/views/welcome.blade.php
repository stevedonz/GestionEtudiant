   ...
   <div class="container marketing">
    ...
    <div class="row">
      <div class="col-lg-4">
        ...
        <h2>ALLEMAND</h2>
        <p>Vous envisagez poursuivre vos études en Allemagne ou y allez pour des raisons proféssionnelles, suivre des cours d’Allemand est une étape importantee dans la réalisation de votre projet. Nos cours d’Allemand vous préparent aux différentes certifications telles que le ZDaf, le TestDaf.</p>
        <p><a class="btn btn-secondary" href="https://www.cticamer.com/allemand/">View details &raquo;</a></p>
      </div><!-- /.col-lg-4 -->
      <div class="col-lg-4">
        <svg class="bd-placeholder-img rounded-circle" width="140" height="140" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#777"/><text x="50%" y="50%" fill="#777" dy=".3em">140x140</text></svg>
        ...
        <p><a class="btn btn-secondary" href="https://www.cticamer.com/anglais/">View details &raquo;</a></p>
      </div><!-- /.col-lg-4 -->
      <div class="col-lg-4">
        <svg class="bd-placeholder-img rounded-circle" width="140" height="140" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#777"/><text x="50%" y="50%" fill="#777" dy=".3em">140x140</text></svg>
        ...
        <h2>ITALIEN</h2>
        <p>Parlez couramment l'italien en 6 mois, apprenez la culture italienne. </p>
        <p><a class="btn btn-secondary" href="https://www.cticamer.com/italien/">View details &raquo;</a></p>
      </div><!-- /.col-lg-4 -->
    </div><!-- /.row -->
