      ...
      <div class="col">
        <div class="card card-cover h-100 overflow-hidden text-white bg-dark rounded-5 shadow-lg" style="background-image: url('unsplash-photo-3.jpg');">
          <div class="d-flex flex-column h-100 p-5 pb-3 text-shadow-1">
            <h2 class="pt-5 mt-5 mb-4 display-6 lh-1 fw-bold">Italian test </h2>
             <p style="font-size: 18px; color: white;">CILS  </p>  </br>
              <p style="font-size: 18px; color: white;">PLIDA </p>   </br>
               <p style="font-size: 18px; color: white;"> CELI </p> </br>
